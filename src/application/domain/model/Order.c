...
T* order_constructor(int id){
  ...
  Hashmap_Entry identifiant = {.key="id",.type=Item_string_noaloc,.value="-1"};
  map->push(map,identifiant);
  Hashmap_Entry type = {.key="type",.type=Item_string_noaloc,.value="Market"};
  map->push(map,type);
  Hashmap_Entry status = {.key="status",.type=Item_string_noaloc,.value="0"};
  map->push(map,status);
  Hashmap_Entry limit = {.key="limit",.type=Item_string_noaloc,.value="0"};
  map->push(map,limit);
  Hashmap_Entry price = {.key="price",.type=Item_string_noaloc,.value="0"};
  map->push(map,price);
  Hashmap_Entry side = {.key="side",.type=Item_string_noaloc,.value="0"};
  map->push(map,side);
  Hashmap_Entry size = {.key="size",.type=Item_string_noaloc,.value="0"};
  map->push(map,size);
  Hashmap_Entry executed_price = {.key="executed_price",.type=Item_string_noaloc,.value="0"};
  map->push(map,executed_price);
  Hashmap_Entry ttl = {.key="ttl",.type=Item_string_noaloc,.value="0"};
  map->push(map,ttl);
  private->map = map;
